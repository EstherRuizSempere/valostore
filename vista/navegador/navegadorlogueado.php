                    ...
                    <ul class="nav nav-pills ms-auto iconos-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/vista/backoffice/producto/tablaProducto.php"><i class="bi bi-pencil"></i> Gestión Productos</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="/vista/backoffice/perfil/zonaAdmin.php"><i class="bi bi-person me-2"></i> Mi Perfil</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="/./servicios/autentifiacion/logout.php"><i class="bi bi-box-arrow-right me-2"></i> Cerrar sesión</a></li>
