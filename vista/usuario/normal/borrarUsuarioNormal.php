...
<head>
    ...
    <link rel="stylesheet" href="../../../media/styles/borrarUsuario.css">
                ...
                <ul class="nav nav-pills ms-auto iconos-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu">
                            <li><a class="dropdown-item" href=""><i class="bi bi-person me-2"></i>Mi
                                    Perfil</a></li>
                            <li><a class="dropdown-item" href=""><i class="bi bi-box me-2"></i>Mis
                                    Pedidos</a></li>
                            <li>
            ...
            <div class="col-lg-6">
                <div class="card perfil-card mb-4">
                    <div class="card-header">
                        <h3><i class="bi bi-exclamation-triangle"></i> Eliminar Cuenta</h3>
                    </div>
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-md-8 text-center">
                                <h4 class="mb-4 p-3"><i class="bi bi-person-x me-4"></i>¿Estás seguro de que deseas
                                    eliminar tu cuenta?</h4>
                                <p class="mb-4">Esta acción no se puede deshacer.
                                    Se eliminarán todos tus datos, incluyendo:</p>
                                <div class="status-item mb-4">
                                    <ul class="lista text-center">
                                        <li><i class="bi bi-person-badge"></i> Perfil de usuario</li>
                                        <li><i class="bi bi-box"></i> Historial de pedidos</li>
                                        <li><i class="bi bi-people"></i> Personajes adquiridos</li>
